...
<html xmlns = "http://www.w3.org/1999/xhtml"> 
	...
	<div class="wrapper"> 
	  ...
	  <div class="content">
				...
				<%
					if (panelAge > 0) {
						double[] powerToDate = new double[panelAge];
						double[] savingsToDate = new double[panelAge];
						double[] carbonSavingsToDate = new double[panelAge];
						for (int i = 0; i < powerToDate.length; i++) powerToDate[i] = power[i];
						for (int i = 0; i < savingsToDate.length; i++) savingsToDate[i] = savings[i];
						for (int i = 0; i < carbonSavingsToDate.length; i++) carbonSavingsToDate[i] = carbonSavings[i];
						
						out.print("<p align=\"center\"><span class=\"winners\">Results to Date</span></p>");
						out.print("<div align=\"center\">");
						out.print("<table width=\"644\" border=\"0\" cellpadding=\"3\" cellspacing=\"7\" class=\"tableborder\">");
						out.print("<tr>");
						out.print("<td width=\"211\" scope=\"col\"><div align=\"center\"><strong>Estimated Power Generation </strong></div></td>");
						out.print("<td width=\"218\" scope=\"col\"><div align=\"center\"><strong>Estimated Cost Savings </strong></div></td>");
						out.print("<td width=\"169\" scope=\"col\"><div align=\"center\"><strong>Estimated Carbon Savings </strong></div></td>");
						out.print("</tr>");
						out.print("<tr>");
						out.print("<td scope=\"col\"><div align=\"center\">" + Math.round(t.sumResult(powerToDate) / 1000) + "Kw" + "</div></td>");
						out.print("<td scope=\"col\"><div align=\"center\">" + "$" + Math.round(t.sumResult(savingsToDate)) + "</div></td>");
						out.print("<td scope=\"col\"><div align=\"center\">" + Math.round(t.sumResult(carbonSavingsToDate) / 100.0) / 10.0 + " tonnes" + "</div></td>");
						out.print("</tr>");
						out.print("</table>");
						out.print("</div>");
					}
...
<table width="1017" border="0" cellpadding="3" cellspacing="7" class="tableborder">
                      ...
                      <tr>
                        ...
                        <td class="style32" scope="col"><% out.print(Math.round(t.calculateDailyAverage(carbonSavings) * 365.25 / 100.0) / 10.0 + " tonnes"); %>
						(<% out.print(Math.round(t.calculateDailyAverage(carbonSavings)) + "kg"); %> a day).</td>
                        <td scope="col"><strong>Total Carbon Savings: </strong></td>
                        <td class="style32" scope="col"><% out.print(Math.round(t.sumResult(carbonSavings) / 100.0) / 10.0 + " tonnes"); %>.</td>  
                      </tr>
                  </table>
                  </div>
                  <p>&nbsp;</p>
                    	...
                    	<td>
					  	...
					  	<td>
					  		...
					  		<% 
								// Draw the power generation graph
								out.print("<img src=\"http://ebusiness.net78.net/inctrendoverview.php?data=");
								for (int i = 0; i < 20; i++) out.print(Math.round(carbonSavings[i] / 100.0) / 10.0 + "*");
								out.print("0\" />");
							%>
					  		</div>
				 	  </td>	
				...
				<table width="399" border="0" cellspacing="0" cellpadding="3">
                  <tr>
                    ...
                    <th width="213" scope="col"><div align="left"><span class="style32">
                      <% 
					  	if (t.calculateBreakEven(savings) > 0) {
					  		out.print(t.calculateBreakEven(savings) + " years."); 
						} else {
							out.print("No break even will occur.");
						}
					  %>
					  </span></div></th>
                  </tr>
